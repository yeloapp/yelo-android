...
class TextDrawer {
    ...
    public void calculateTextPosition(int canvasW, int canvasH, ShowcaseView showcaseView, boolean shouldCentreText) {
        ...
        int[] areas = new int[5]; //left,top, right, bottom,center
        ...
        areas[4] = showcase.top * (canvasH / 2);
        ...
        switch (largest) {
            case 0:
              ...
              mBestTextPosition[1] = padding + showcase.top;
...
//                mBestTextPosition[2] = showcase.left - 2 * padding;
            ...
            case 1:
                mBestTextPosition[0] = 2*padding;
                mBestTextPosition[1] = padding + (canvasH/2);
                mBestTextPosition[2] = canvasW - 2 * padding;
