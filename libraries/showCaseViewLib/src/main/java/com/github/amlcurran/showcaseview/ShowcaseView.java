...
//    }
    ...
    /**
     *
     * better solution is to change the  updateBitmap(). Passing any
     * non-zero dimension values to the createBitmap() function when getMeasure* returns 0 would
     * ensure the bitmap is created with a valid size. Since updateBitmap() function will be called
     * again as soon as the view gets is actual size, this poses no problem
     * - Anshul
     */
    private void updateBitmap() {
        if (bitmapBuffer == null || haveBoundsChanged()) {
    ...
    public static class Builder {
        ...
        /**
         * Set the inner radius of the new showcase view
         */
        public Builder setInnerRadius(float innerRadius) {
            showcaseView.setInnerRadius(innerRadius);
            return this;
        }

        /**
         * Set the outer radius of the new showcase view
         */
        public Builder setOuterRadius(float outerRadius) {
            showcaseView.setOuterRadius(outerRadius);
            return this;
        }
