 ...
 * @since 3/05/15
 * <p/>
 * Controller responsible for showing details of a wall in the form of pager
 */
public class WallPostPagerFragment extends AbstractYeloFragment implements View.OnClickListener,
        ViewPager.OnPageChangeListener, SlidingTabLayout.MyTabClickListener,
        LoaderManager.LoaderCallbacks<Cursor>, RetroCallback.RetroResponseListener,
        DBInterface.AsyncDbQueryCallback {

    public static final String TAG = "WallPostPagerFragment";
...
//                mShareImage = putOverlayRight(getActivity(), mShareImage, iconTop);
    ...
    private void fetchUserDetailsFromServer(String userId) {
        ...
        retroCallback.setRequestId(ApiResponseCodes.GET_USER_DETAILS);
    ...
    public static WallPostPagerFragment newInstance(Bundle args) {
        WallPostPagerFragment f = new WallPostPagerFragment();
        f.setArguments(args);
        return f;
    }
