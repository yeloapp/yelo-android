 ...
 * More implementation. This class will be set as the {@link android.widget.AbsListView.OnScrollListener}
 * for the list, so if you need to capture the scroll events, you can provide
 * your own {@link android.widget.AbsListView.OnScrollListener} through the relevant methods
 *
 */
public class LoadMoreHelper implements OnScrollListener {
    ...
    /**
     * External {@link android.widget.AbsListView.OnScrollListener} listener
     */
    private OnScrollListener    mExternalOnScrollListener;

    /**
     * Reference to the {@link android.widget.AbsListView} which needs the Load More
     * implementation
     */
    ...
    /**
     * Set an external {@link android.widget.AbsListView.OnScrollListener} to receive the OnScroll events
     *
     * @param onScrollListener The {@link android.widget.AbsListView.OnScrollListener} to move up the
     *            scroll events
     */
    ...
    /**
     * Set the {@link android.widget.AbsListView} reference to provide the load more callbacks
     * on
     *
     * @param absListView The {@link android.widget.AbsListView} to provide load more
     *            functionality
     */
    ...
    /**
     * Gets the external {@link android.widget.AbsListView.OnScrollListener} added
     */
    ...
    /**
     * Sets an external {@link android.widget.AbsListView.OnScrollListener} to receive the scroll events
     */
