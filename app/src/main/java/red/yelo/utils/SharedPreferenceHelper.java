...
public class SharedPreferenceHelper {
    ...
    public static boolean contains(final int key) {
        final SharedPreferences preferences = PreferenceManager
                .getDefaultSharedPreferences(YeloApplication
                        .getStaticContext());
        return preferences.contains(YeloApplication.getStaticContext()
                                                       .getString(key));
    }
    ...
    public static String getString(final int key, final String defValue) {
        ...
        final SharedPreferences preferences = PreferenceManager
                .getDefaultSharedPreferences(YeloApplication
                        .getStaticContext());
        return preferences.getString(YeloApplication.getStaticContext()
    ...
    public static int getInt(final int key, final int defValue) {
        ...
        final SharedPreferences preferences = PreferenceManager
                .getDefaultSharedPreferences(YeloApplication
                        .getStaticContext());
        return preferences.getInt(YeloApplication.getStaticContext()
                                                     .getString(key), defValue);
    }
    ...
    public static float getFloat(final int key, final float defValue) {
        ...
        final SharedPreferences preferences = PreferenceManager
                .getDefaultSharedPreferences(YeloApplication
                        .getStaticContext());
        return preferences.getFloat(YeloApplication.getStaticContext()
                                                       .getString(key), defValue);
    ...
    public static long getLong(final int key, final long defValue) {
        ...
        final SharedPreferences preferences = PreferenceManager
                .getDefaultSharedPreferences(YeloApplication
                        .getStaticContext());
        return preferences.getLong(YeloApplication.getStaticContext()
                                                      .getString(key), defValue);
    }
    ...
    public static boolean getBoolean(final int key, final boolean defValue) {
        ...
        final SharedPreferences preferences = PreferenceManager
                .getDefaultSharedPreferences(YeloApplication
                        .getStaticContext());
        return preferences.getBoolean(YeloApplication.getStaticContext()
                                                         .getString(key), defValue);
    }
    ...
    public static void set(final int key, final String value) {
        ...
        editor.putString(YeloApplication.getStaticContext().getString(key), value);
        editor.commit();
    }
    ...
    public static void set(final int key, final int value) {
        ...
        final SharedPreferences preferences = PreferenceManager
                .getDefaultSharedPreferences(YeloApplication
                        .getStaticContext());
        final SharedPreferences.Editor editor = preferences.edit();
        editor.putInt(YeloApplication.getStaticContext().getString(key), value);
        editor.commit();
    }
    ...
    public static void set(final int key, final float value) {
        ...
        editor.putFloat(YeloApplication.getStaticContext().getString(key), value);
        editor.commit();
    }
    ...
    public static void set(final int key, final double value) {
        ...
        editor.putString(YeloApplication.getStaticContext().getString(key), String
                .valueOf(value));
        editor.commit();
    }
    ...
    public static void set(final int key, final long value) {
        ...
        final SharedPreferences preferences = PreferenceManager
                .getDefaultSharedPreferences(YeloApplication
                        .getStaticContext());
        final SharedPreferences.Editor editor = preferences.edit();
        editor.putLong(YeloApplication.getStaticContext().getString(key), value);
        editor.commit();
    }
    ...
    public static void set(final int key, final boolean value) {
        ...
        final SharedPreferences preferences = PreferenceManager
                .getDefaultSharedPreferences(YeloApplication
                        .getStaticContext());
        final SharedPreferences.Editor editor = preferences.edit();
        editor.putBoolean(YeloApplication.getStaticContext().getString(key), value);
        editor.commit();
    }
    ...
    public static void registerSharedPreferencesChangedListener(final SharedPreferences.OnSharedPreferenceChangeListener onSharedPreferenceChangeListener) {
        ...
        final SharedPreferences preferences = PreferenceManager
                .getDefaultSharedPreferences(YeloApplication.getStaticContext());
