...
public class LocationSuggestionAdapter extends CursorAdapter {
     ...
     */
    public LocationSuggestionAdapter(final Context context) {
    ...
    public void bindView(final View view, final Context context,
        ...
        String place = cursor.getString(cursor
                .getColumnIndex(DatabaseColumns.PLACE_NAME));
        holder.textPlace.setText(place);
    }
    ...
    public View newView(final Context context, final Cursor cursor,
        ...
        final View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.layout_location_suggesstion_list, parent, false);
    ...
    private class LocationHolder extends RecyclerView.ViewHolder {
        ...
        public LocationHolder(View itemView) {
            super(itemView);
            textPlace = (TextView) itemView.findViewById(R.id.place_name);
        }
    }
}
