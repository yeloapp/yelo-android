 ...
 */
public class TableSearchWallPosts {

    private static final String TAG = "TableSearchWallPosts";

    public static final String NAME = "WALL_SEARCH_POSTS";
    ...
    public static void create(final SQLiteDatabase db) {
        ...
        final String columnDef = TextUtils
                .join(SQLConstants.COMMA, new String[]{
                        ...
                        String.format(Locale.US, SQLConstants.DATA_TEXT, DatabaseColumns.TAG_USER_COUNT, ""),
                        String.format(Locale.US, SQLConstants.DATA_TEXT, DatabaseColumns.CHAT_USER_COUNT, ""),
