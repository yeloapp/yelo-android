...
/**
 * @author Anshul Kamboj Table representing all my wall comments
 */
public class TableMyWallComments {

    private static final String TAG  = "TableMyWallComments";

    public static final String  NAME = "MY_WALL_COMMENTS";
    ...
    public static void create(final SQLiteDatabase db) {
        ...
        final String columnDef = TextUtils
                        .join(SQLConstants.COMMA, new String[] {
                                ...
                                String.format(Locale.US, SQLConstants.DATA_TEXT, DatabaseColumns.IS_PRESENT, "false")
