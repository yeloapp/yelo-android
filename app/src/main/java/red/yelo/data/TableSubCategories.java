...
/**
 * @author Anshul Kamboj Table representing all the subcategories
 */
public class TableSubCategories {

    private static final String TAG  = "TableSubCategories";

    public static final String  NAME = "SUBCATEGORIES";
    ...
    public static void create(final SQLiteDatabase db) {
        ...
        final String columnDef = TextUtils
                        .join(SQLConstants.COMMA, new String[] {
                                ...
                                String.format(Locale.US, SQLConstants.DATA_TEXT, DatabaseColumns.KEYWORDS, ""),
