 ...
 */
public class TableCollectionUsers {

    private static final String TAG  = "TableCollectionUsers";

    public static final String  NAME = "COLLECTION_USERS";
    ...
    public static void create(final SQLiteDatabase db) {
        ...
        final String columnDef = TextUtils
                        .join(SQLConstants.COMMA, new String[] {
                                ...
                                String.format(Locale.US, SQLConstants.DATA_TEXT, DatabaseColumns.COLLECTION_ID, ""),
                                ...
                                String.format(Locale.US, SQLConstants.DATA_TEXT, DatabaseColumns.AVATAR, ""),
                                String.format(Locale.US, SQLConstants.DATA_TEXT, DatabaseColumns.AVATAR_DESCRIPTION, ""),
                                String.format(Locale.US, SQLConstants.DATA_TEXT, DatabaseColumns.TAGS, ""),
                                String.format(Locale.US, SQLConstants.DATA_TEXT, DatabaseColumns.TAG_IDS, ""),
