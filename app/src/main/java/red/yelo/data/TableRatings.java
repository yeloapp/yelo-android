...
/**
 * @author Anshul Kamboj Table representing ratings for user
 */
public class TableRatings {

    private static final String TAG  = "TableRatings";
    ...
    public static void create(final SQLiteDatabase db) {
        ...
        final String columnDef = TextUtils
                        .join(SQLConstants.COMMA, new String[] {
                                ...
                                String.format(Locale.US, SQLConstants.DATA_TEXT, DatabaseColumns.STARS, ""),
